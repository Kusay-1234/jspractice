...
//Find number is positive, negative and zero
...
//   if (a > b && a > c){
//     console.log(`The number ${a} is largest among all.`);
//   }
//   else if (b > a && b > c){
//     console.log(`The number ${b} is largest among all.`);
//   }
//   else {
//     console.log(`The number ${c} is largest among all.`);
//   }
// }
